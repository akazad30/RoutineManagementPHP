...
<html>
    <head>
        ...
        <link rel="stylesheet" href="show_routine.css" type="text/css" />      
    </head>

    <body>
    <div class="main">
        <?php
            if(isset($_POST['show_routine']))
            echo "<table>";
                        ...
                        echo "<tr>";
                            echo "<td rowspan='6'>$day[$i]</td>";
                                for($j = 0; $j < 5; $j++)
                                {
                                    ...
                                    $query = "select time, sub, tName from r where day = '".$day[$i]."' and semester = '".$semester[$j]."';";
